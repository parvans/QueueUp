...
export default function QueueDetailsPlaceholder() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FAF8FF]">
      <View className="px-5 py-3 flex-row items-center gap-3 border-b border-border bg-white">
        ...
        <Text className="text-lg font-bold text-[#131B2E]">Queue Details</Text>
      </View>
      <View className="flex-1 items-center justify-center p-6">
        <Ionicons name="medkit-outline" size={48} color="#2563EB" />
        <Text className="text-xl font-bold text-[#131B2E] mt-3">Queue: {id}</Text>
        <Text className="text-sm text-[#434655] text-center mt-1">
          Full screen to be implemented in Screen 6.
        </Text>
      </View>
    </SafeAreaView>
  );
