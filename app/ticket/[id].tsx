...
export default function TicketPlaceholder() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FAF8FF]">
      <View className="px-5 py-3 flex-row items-center gap-3 border-b border-border bg-white">
        ...
        <Text className="text-lg font-bold text-[#131B2E]">Digital Queue Ticket</Text>
      </View>
      <View className="flex-1 items-center justify-center p-6">
        <Ionicons name="qr-code-outline" size={48} color="#2563EB" />
        <Text className="text-xl font-bold text-[#131B2E] mt-3">Ticket: {id}</Text>
        <Text className="text-sm text-[#434655] text-center mt-1">
          Full screen to be implemented in Screen 9.
        </Text>
      </View>
    </SafeAreaView>
  );
